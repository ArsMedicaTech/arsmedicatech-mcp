...
def test_optimal_tools():
    ...
    portfolio = create_portfolio_optimization(
        assets, expected_returns, covariance_matrix, target_return=0.09
    )
    ...
    allocation = create_resource_allocation_problem(
        resources, tasks, resource_capacities, task_requirements
    )
