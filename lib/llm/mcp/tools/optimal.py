...
try:
    from amt_nano.services.optimal import OptimalService, OptimalSchema, OptimalMetadata
except ImportError:
...
def create_linear_optimization_problem(
    ...
    try:
        ...
        return {
            "error": f"Failed to create optimization problem: {str(e)}"
        }
...
def validate_optimization_problem(problem_schema: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        required_fields = ["meta", "variables", "objective", "constraints", "initial_guess"]
