...
async def analyze_medical_image_tool(
    image_url: str = Field(description="Public or signed URL to a PNG/JPG X-ray, derm photo, pathology slide, etc."),
    view: Optional[str] = Field(default=None, description="Optional imaging view / angle (AP, PA, Lateral, DermCloseUp, Other)"),
    prompt: Optional[str] = Field(default=None, description="Optional free-text question for the model (e.g. 'Describe notable abnormalities')"),
...
async def batch_analyze_medical_images_tool(
    ...
    view: Optional[str] = Field(default=None, description="Optional imaging view / angle"),
    prompt: Optional[str] = Field(default=None, description="Optional free-text question for the model"),
    ctx: Optional[Context] = None
) -> Dict[str, Any]:
    """
